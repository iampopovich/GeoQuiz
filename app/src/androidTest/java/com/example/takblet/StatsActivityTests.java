...
public class StatsActivityTests {

    @Rule
    public ActivityScenarioRule<StatsActivity> activityRule =
    ...
    public void recyclerViewAppears(){
        onView(withId(R.id.quizResultsRecyclerView)).check(matches(isDisplayed()));
    }
